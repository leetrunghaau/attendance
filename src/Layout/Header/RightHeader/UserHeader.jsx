...
import man from '../../../assets/images/login/user.png';
...
const UserHeader = () => {
  ...
  useEffect(() => {
    ...
    setName(details.HoTen);
  }, []);

  const Logout = () => {
    localStorage.removeItem(LocalStorageKey.LoginInfo);
      ...
      <div className='media profile-media'>
        ...
        <div className='media-body'>
          ...
          <P attrPara={{ className: 'mb-0 font-roboto' }}>
            {details.admin==1?"Admin":"User"} <i className='middle fa fa-angle-down'></i>
          </P>
        </div>
      </div>
