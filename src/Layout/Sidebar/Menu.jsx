...
export const MENUITEMS = [
  {
    //ID:FunctionsID.QuanTri,
    ROLE:'ADMIN',
    menutitle: "Quản trị",
    menucontent: " ",
    Items: [
      {
        //ID:FunctionsID.DanhMuc,
        title: "Danh mục",
        icon: "layout",
        type: "sub",
        active: false,
        children: [
          {
            ...
            icon: "user",
            path: `${process.env.PUBLIC_URL}/QuanTri/DanhSachUser`,
            active: false,
            type: "link",
            compareActive: "DanhSachUser",
          },   
          {
            title: "Danh sách tiêu chí",
            icon: "user",
            path: `${process.env.PUBLIC_URL}/DanhMuc/DanhSachTieuChi`,
            active: false,
            type: "link",
            compareActive: "DanhSachTieuChi",
          },  
          {
            title: "Phân công đánh giá",
            icon: "user",
            path: `${process.env.PUBLIC_URL}/DanhGia/PhanCongDanhGia`,
            active: false,
            type: "link",
            compareActive: "PhanCongDanhGia",
          },          
        ],
      },
    ...
    Items: [
      {
        ROLE:'ADMIN',
        icon: "layout",
        path: `${process.env.PUBLIC_URL}/ChamDiem/TheoDoiChamDiem`,
        title: "Theo dõi chấm điểm",
        type: "link",
        compareActive: "TheoDoiChamDiem",
      }, 
      {
        ROLE:'1',
        icon: "layout",
        path: `${process.env.PUBLIC_URL}/ChamDiem/TuCham`,
        title: "Tự chấm",
        type: "link",
        compareActive: "TuCham",
      }, 
      {
        ROLE:'2',
        icon: "layout",
        path: `${process.env.PUBLIC_URL}/ChamDiem/ChamThamDinh`,
        title: "Chấm thẩm định",
        type: "link",
        compareActive: "ChamThamDinh",
      }, 
    ],
  },
  {
    ...
    Items: [
      {
        ROLE:'ADMIN',
        icon: "layout",
        path: `${process.env.PUBLIC_URL}/NhanXet/TongHopNhanXet`,
        title: "Tổng hợp nhận xét",
        type: "link",
        compareActive: "TongHopNhanXet",
      }, 
      {
        ROLE:'ADMIN',
        icon: "layout",
        path: `${process.env.PUBLIC_URL}/NhanXet/TheoDoiNhanXet`,
        title: "Theo dõi nhận xét",
        type: "link",
        compareActive: "TheoDoiNhanXet",
      }, 
      {
        ROLE:'1',
        icon: "layout",
        path: `${process.env.PUBLIC_URL}/NhanXet/TuNhanXet`,
        title: "Tự nhận xét",
        type: "link",
        compareActive: "TuNhanXet",
      }, 
      {
        ROLE:'2',
        icon: "layout",
        path: `${process.env.PUBLIC_URL}/NhanXet/NhanXetChoDonVi`,
        title: "Nhận xét cho đơn vị",
        type: "link",
        compareActive: "NhanXetChoDonVi",
      }, 
  ...
  },
  {
    ...
    Items: [
      {
        icon: "layout",
        path: `${process.env.PUBLIC_URL}/TongKet/LuuFile`,
        title: "Quản lý file",
        type: "link",
        compareActive: "LuuFile",
      }
  ...
  //               title: "Timepicker",
  //               type: "link",
  //               path: `${process.env.PUBLIC_URL}/forms/widget/timepicker`,
  //             },
  //             {
  ...
  //               type: "link",
  //               path: `${process.env.PUBLIC_URL}/pages/authentication/sign-up-two`,
  //             },
  //             {
  //               title: "Unloack User",
  //               type: "link",
