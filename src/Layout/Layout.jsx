...
import CommonTaiLieu from '../Components/Common/CommonShowTaiLieu';
    ...
    <Fragment>      
      ...
      <div className={`page-wrapper ${layout1}`} sidebar-layout={sideBarIcon} id='pageWrapper'>
        ...
        <div className='page-body-wrapper'>
          ...
          <CommonTaiLieu
          // showModal={showPDF}
          // setShowModal={(value) => setShowPDF(value)}
          // item={itemUpdate}
          // FileBase64={base64File}
          // setFileBase64={(value) => setBase64File(value)}
          // Extension={extension}
          // setExtension={(value) => setExtension(value)}
          // DownloadTaiLieu={downloadTaiLieu}
          // FileName={fileName}
        />
          <Footer />
        </div>
