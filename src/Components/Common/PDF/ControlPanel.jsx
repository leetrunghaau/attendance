...
const ControlPanel = (props) => {
  ...
  return (
    <div className="control-panel m-3 p-3 d-flex align-items-baseline justify-content-between" style={{width:'100%'}}>
      <div className="d-flex justify-content-between align-items-baseline">
        ...
        <span>
          ...
          <input
            ...
            min={1}
            max={numPages || 1}
            className="p-0 pl-1 mx-2 text-center"
            value={pageNumber}
      ...
      <div className="d-flex justify-content-between align-items-baseline">
      <i
          className={`fa fa-download mx-3 clickable`}
