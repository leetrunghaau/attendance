...
export const post = async (url, data, param = null, responseType = 'json') => {  //responseType=arraybuffer/stream/json
    let token = '';
...
export const get = async (url, params, header, timeout = 30000) => {
    let token = '';
    const loginInfo = JSON.parse(localStorage.getItem(LocalStorageKey.LoginInfo));
    if (loginInfo) {
        token = loginInfo.token;
