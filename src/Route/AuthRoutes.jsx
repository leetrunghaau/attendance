import ComingSimple from '../Screens/ComingSoon/ComingSimple';
import CreatePwd from '../Screens/Auth/CreatePwd';
import ForgetPwd from '../Screens/Auth/ForgetPwd';
import LoginOne from '../Screens/Auth/LoginOne';
import LoginSweetalert from '../Screens/Auth/LoginSweetalert';
import LoginTooltip from '../Screens/Auth/LoginTooltip';
import LoginTwo from '../Screens/Auth/LoginTwo';
import LoginValidation from '../Screens/Auth/LoginValidation';
import Maintenance from '../Screens/Auth/Maintenance';
import RegisterBgImg from '../Screens/Auth/RegisterBgImg';
import RegisterSimple from '../Screens/Auth/RegisterSimple';
import RegisterVideo from '../Screens/Auth/RegisterVideo';
import UnlockUser from '../Screens/Auth/UnlockUser';
import ErrorPage1 from '../Screens/ErrorPages/ErrorPage400';
import ErrorPage2 from '../Screens/ErrorPages/ErrorPage401';
import ErrorPage3 from '../Screens/ErrorPages/ErrorPage403';
import ErrorPage4 from '../Screens/ErrorPages/ErrorPage404';
import Logins from '../Auth/Signin';
import LoginForm from '../Screens/Auth/LoginForm';
import ComingBgImg from '../Screens/ComingSoon/ComingBgImg';
import ComingBgVideo from '../Screens/ComingSoon/ComingBgVideo';
import Error500 from '../Screens/ErrorPages/ErrorPage500';
import Error503 from '../Screens/ErrorPages/ErrorPage503';
